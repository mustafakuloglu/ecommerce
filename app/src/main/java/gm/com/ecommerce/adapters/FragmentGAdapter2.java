 ...
 */
public class FragmentGAdapter2  extends RecyclerView.Adapter<FragmentGAdapter2.ViewHolder> {
    ...
    public FragmentGAdapter2(List<ModelG> list_person) {
    ...
    @Override
    public FragmentGAdapter2.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
