 ...
 */
public class ActivityEAdapter extends RecyclerView.Adapter<ActivityEAdapter.ViewHolder> {
    ...
    public ActivityEAdapter(List<Person> list_person) {
    ...
    @Override
    public ActivityEAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
